...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-[#03203C] text-white">
                <div>
                    <img className='h-24 mx-auto rounded-full text-center' src={logo} alt="" />
                    <p className='text-white text-center text-3xl font-semibold'>Twinkle - Kids Doll Store</p>
                </div>
                <div>
                    ...
                    <p className='mt-2'>Available: Sat-Friday, 09:00am to 8:00pm</p>
                </div>
                <div>
                    <span className="footer-title">Useful Links</span>
                    <a className="link link-hover">Barbie Dolls</a>
                    <a className="link link-hover">Baby Dolls</a>
                    <a className="link link-hover">Cute Dolls</a>
            ...
            <footer className="footer items-center p-4 bg-[#120E43] text-neutral-content">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Copyright © 2023 - Twinkle - Kids Doll Store</p>
                </div>
